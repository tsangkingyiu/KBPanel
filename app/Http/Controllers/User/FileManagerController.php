...
/**
 * User File Manager Controller
 * Restricted to user's own projects only
 */
class FileManagerController extends Controller
{
    ...
    public function __construct(FileManagerService $fileManager)
    {
        ...
        $this->middleware('project.ownership');
    }

    /**
     * Display file manager for user's projects
     */
    public function index()
    {
        $projects = auth()->user()->projects;
        
        return view('user.file-manager.index', [
            'projects' => $projects
        ]);
    }

    /**
     * Browse files for user's project
     */
    public function browse(Request $request, Project $project)
    {
        // Middleware ensures ownership, but double-check
